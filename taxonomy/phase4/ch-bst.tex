...
(\cref{thm:nonenum-pownat}) can be restated as
...
argument in \cref{thm:nonenum-pownat}, and was the inspiration for
Russell's Paradox.
...
\index{Schroder-Bernstein theorem}
