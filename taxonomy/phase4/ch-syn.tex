...
\index{language}\index{signature}
\label{PRIM-SYN009}
...
\index{formula}\index{formula!atomic}\index{formula!well-formed}
\label{PRIM-SYN012}
...
\index{structural induction!on terms}
...
\index{structural induction!on formulas}
    \label{DEF-SYN005}
    Let $\Lang L$ be a first-order language.
...
\index{formula complexity}\index{structural recursion}
\label{DEF-SYN007}
...
\index{formation sequence!for terms}
...
\index{formation sequence!for formulas}
\label{DEF-SYN006}
...
\index{free variable!occurrence}\index{variable!free}
\label{PRIM-SYN014}
...
\index{bounded quantification}\index{quantifier!bounded}
\label{DEF-SYN009}
...
\index{unique readability!for atomic formulas}
\label{THM-SYN002}
...
\index{structural induction}\index{structural recursion!principle}
\label{THM-SYN004}
\leavevmode
\begin{enumerate}
...
Part~(2) follows from unique readability (\cref{THM-SYN001}):
