...
\begin{defn}[$\Delta_0$, $\Sigma_1$, $\Pi_1$ formulas] % DEF-INC016, DEF-INC017
\label{DEF-INC016}
...
(see DEF-CMP009, Representability, \S CMP.5),
$\Th{Q} \Proves \eq[\num{n_1} + \num{n_2}][\num{n_1 + n_2}]$,
...
the Kleene Normal Form Theorem (see DEF-CMP005, \S CMP.3).
