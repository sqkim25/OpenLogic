...
notion of the rank of a set (see SET.3). Given $\ZFminus$, we can
...
\begin{proof}[Proof sketch]
For any cardinal $\cardfont{a}$, Cantor's Theorem (PRIM-BST017,
...
$\phi(x)$. Working in $\ZF$, one defines the \textsc{ts}-cardinality of
...
\begin{proof}
From Cantor's Theorem (PRIM-BST017, Chapter~\ref{ch:bst}) and
